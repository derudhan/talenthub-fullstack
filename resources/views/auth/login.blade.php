...
<html lang="en">
    ...
    <body class="bg-gray-100 dark:bg-gray-900 flex items-center justify-center flex-col min-h-screen p-6">
        <div class="flex justify-center mb-4">
            <img src="{{ asset('images/icon.png') }}" alt="News Talenthub Logo" class="h-12">
        </div>
                ...
                <form method="POST" action="{{ route('login.post') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="password" id="password" name="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" minlength="6" required>
                            @error('password')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
